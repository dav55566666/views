...
$(".openmenubtn").click(function () { $(".menu").slideToggle(500) })
...
var swiper = new Swiper(".portfolio .swiper", {
    loop: true,
    navigation: {
        nextEl: ".portfolio .slidenext",
        prevEl: ".portfolio .slideprev",
    },
});


var main_bullets = $(".main_swiper .swiper-pagination-bullet");
for (var i = 0; i < main_bullets.length; i++) {
    if (i < 9) {
        let mainbulletnum = $(main_bullets[i]).text()
        $(main_bullets[i]).text("0" + mainbulletnum + "")
    }
}
