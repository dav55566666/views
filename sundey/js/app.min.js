...
$(".menubtn").click(function(){
    $(".hidemenu").css("width","100%");
    $(".hidemenu").css("overflow","auto");
})
$(".back").click(function(){
    $(".hidemenu").css("width","0");
    $(".hidemenu").css("overflow","hidden");
})
$(".cancle").click(function(){
    $(".splitmodal").slideUp(500)
    $(".pricepmodal").slideUp(500)
    $(".pricep").text("");
    $(".pricep").hide();
})
$(".opensplitmodal").click(function(){
    $(".splitmodal").slideDown(500)
    $("#priceinput").val('')
})
$("#priceinput").on("input",function(){
    if($(this).val()>0){
        $(".cancle").addClass("confirmsplit")
        $(".confirmsplit").removeClass("cancle")
        $(".confirmsplit").text("confirm")
        $(".confirmsplit").click(function(){
            $(".splitprice").text($("#priceinput").val());
            $(".splitmodal").slideUp(500)
            $(".confirmsplit").addClass("cancle")
            $(".cancle").removeClass("confirmsplit")
            $(".cancle").text("cancel")
        })
    }
    else{
...
var splitprice2 = 0
var splitprice3 = 0
$(".splitaddedbtn").click(function(){
    splitprice = $(".splitprice").text()
    splitprice2 = Number(splitprice)
    $(".splitprice").text($(this).val()*splitprice2);
})
$(".main_cont_bottom_sc-eJCack").click(function(){
    $(".split").slideDown(500)
})
$(".exitsplit").click(function(){
    $(".split").slideUp(500)
})
$(".split_cont_box_grid button").click(function(){
    $(".split_cont_box_grid button").removeClass("activ");
    $(this).addClass("activ");
})
$(".savedcartbtn").click(function(){
    $(".savedcartbtn").addClass("visaactiv")
    $(".gopayment").addClass("gopayment_activ")
    $(".mayn_cont_payment_addcart").removeClass("addcart_activ")
    $(".mayn_cont_payment_addcart_form").slideUp(500)
    $(".applepay").removeClass("applepayactiv")
})
$(".applepay").click(function(){
    $(".savedcartbtn").removeClass("visaactiv")
    $(".applepay").addClass("applepayactiv")
    $(".gopayment").removeClass("gopayment_activ")
    $(".mayn_cont_payment_addcart").removeClass("addcart_activ")
    $(".mayn_cont_payment_addcart_form").slideUp(500)
})
$(".mayn_cont_payment_addcart").click(function(){
    $(".savedcartbtn").removeClass("visaactiv")
    $(".gopayment").removeClass("gopayment_activ")
    $(".mayn_cont_payment_addcart").addClass("addcart_activ")
    $(".mayn_cont_payment_addcart_form").slideDown(500)
    $(".applepay").removeClass("applepayactiv")
})
$(".open_pricepinput").click(function(){
    $(".pricepmodal").slideDown(500)
})
$("#pricepinput").on("input",function(){
    if($(this).val()>0){
        $(".cancle").addClass("confirmsplit")
        $(".confirmsplit").removeClass("cancle")
        $(".confirmsplit").text("confirm")
        $(".confirmsplit").click(function(){
            $(".pricep").text(""+$("#pricepinput").val()+" $");
            $(".pricepmodal").slideUp(500)
            $(".confirmsplit").addClass("cancle")
            $(".cancle").removeClass("confirmsplit")
            $(".pricep").show();
            $(".cancle").text("cancel")
            $(".open_pricepinput svg").hide();
        })
    }
    if($("#pricepinput")<=0){
        $(".pricep").text("");
        $(".open_pricepinput svg").show();
        $(".confirmsplit").addClass("cancle")
        $(".cancle").removeClass("confirmsplit")
        $(".cancle").text("cancel")
        $(".cancle").click(function(){
